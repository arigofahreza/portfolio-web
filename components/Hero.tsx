      ...
      <div className="max-w-7xl mx-auto w-full relative z-10">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            >
              Passionate about building scalable data pipelines and robust backend systems. 
              Transforming raw data into actionable insights and creating efficient, maintainable code.
            </motion.p>
            ...
            >
              ...
              <button className="inline-flex items-center px-6 py-3 border-2 border-cyan-400 text-base font-bold rounded-lg text-cyan-400 hover:bg-cyan-400 hover:text-black transition-all duration-300 shadow-[0_0_15px_rgba(34,211,238,0.2)] hover:shadow-[0_0_25px_rgba(34,211,238,0.4)] backdrop-blur-sm bg-gray-900/50 transform hover:scale-105">
            ...
            >
              <a href="#" className="p-3 text-gray-600 hover:text-blue-600 hover:bg-blue-50 rounded-full transition-colors duration-300">
                <FiGithub size={24} />
              </a>
              <a href="#" className="p-3 text-gray-600 hover:text-blue-600 hover:bg-blue-50 rounded-full transition-colors duration-300">
                <FiLinkedin size={24} />
          ...
          >
            <div className="relative">
              ...
              <div className="absolute -top-4 -right-4 w-20 h-20 bg-blue-100 rounded-full opacity-20 animate-bounce-slow"></div>
              <div className="absolute -bottom-6 -left-6 w-16 h-16 bg-purple-100 rounded-full opacity-20 animate-bounce-slow" style={{ animationDelay: '1s' }}></div>
            </div>
          </motion.div>
        </div>
      </div>
